...
// Dynamic Base Path Calculation (Available System-Wide)
$scriptName = $_SERVER['SCRIPT_NAME'];
$basePath = str_replace(basename($scriptName), '', $scriptName);
// Hide 'public/' from the base path for cleaner URLs
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!validateSession($conn)) {
            ...
            if ($is_ajax || $is_check_script) {
                ...
                header("Location: " . BASE_PATH . "index.php?reason=concurrent_login");
                exit();
            }
        }
    }
