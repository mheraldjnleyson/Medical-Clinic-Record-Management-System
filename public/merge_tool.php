...
<style>
    ...
    @media screen and (max-width: 768px) {
        ...
        .panel.form div[style*="display: flex; gap: 20px"] {
...
<script>
    ...
    function autoFillMerge(type, records) {
        ...
        selectPatient('primary', {
            ...
            department: duplicate.identifier
        });
            ...
            .then(data => {
                if (data.length > 0) {
                    resultsDiv.innerHTML = data.map(p => {
                        ...
                        else if (type === 'employee') sub = 'ID: ' + (p.department || 'N/A');
    ...
    function selectPatient(side, patient) {
        ...
        else if (type === 'employee') subDetails = 'ID: ' + (patient.department || 'N/A');
