...
<section class="controls">
  <form method="GET" action="<?= $basePath ?>student" class="search-box" style="display:flex; align-items:center; width: 100%;">
  ...
  <a href="<?= $basePath ?>census" class="btn"
  ...
  <div class="dropdown" style="margin-left: auto;">
    ...
    <div class="dropdown-content">
      <a href="<?= $basePath ?>export_pdf.php"><i class="fa-solid fa-file-pdf"></i> DOWNLOAD PDF</a>
      <a href="<?= $basePath ?>export_xlsx.php"><i class="fa-solid fa-file-excel"></i> DOWNLOAD XLSX</a>
    </div>
  </div>

  <a href="<?= $basePath ?>generate_qr" class="btn"
    ...
    <div class="record-card-container">
      <div class="record-card">
        ...
        <div class="modal-card-actions">
          <a href="<?= $basePath ?>view_card" id="btn-view-card" class="btn-action view" title="View"><i
              class="fa-solid fa-eye"></i> View</a>
          <a href="<?= $basePath ?>edit_card" id="btn-edit-card" class="btn-action edit" title="Edit"><i
      ...
      <div class="record-card">
        ...
        <div class="modal-card-actions">
          <a href="<?= $basePath ?>view_treatment" id="btn-view-treatment" class="btn-action view" title="View"><i
              class="fa-solid fa-eye"></i> View</a>
          <a href="<?= $basePath ?>edit_treatment" id="btn-edit-treatment" class="btn-action edit" title="Edit"><i
      ...
      <div class="record-card">
        ...
        <div class="modal-card-actions">
          <a href="<?= $basePath ?>view_consent" id="btn-view-consent" class="btn-action view" title="View"><i
              class="fa-solid fa-eye"></i> View</a>
          <a href="<?= $basePath ?>edit_consent" id="btn-edit-consent" class="btn-action edit" title="Edit"><i
              class="fa-solid fa-pen-to-square"></i>
            Edit</a>
        </div>
      </div>
      ...
      <div class="record-card">
        ...
        <div class="modal-card-actions">
          <a href="<?= $basePath ?>medical_records" id="btn-medical-records" class="btn-action view"
