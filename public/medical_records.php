...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($res2->num_rows > 0) {
            ...
            header("Location: " . BASE_PATH . "medical_records?id=$id&type=$otherType" . (isset($_GET['delete_id']) ? "&delete_id=" . $_GET['delete_id'] : ""));
            exit;
        }
...
if (isset($_GET['delete_id'])) {
    ...
    if ($fileRes->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: " . BASE_PATH . "medical_records?id=$id&type=$patientType");
            exit;
        }
    }
}
