...
$sql = "SELECT id, name, lrn as identifier, gender, birth_date, treatment_logs_json, health_exam_json, 'student' as ptype FROM students WHERE is_archived = 0 
        UNION ALL 
        SELECT id, name, department as identifier, gender, birth_date, treatment_logs_json, '' as health_exam_json, 'employee' as ptype FROM employees WHERE is_archived = 0
        UNION ALL
