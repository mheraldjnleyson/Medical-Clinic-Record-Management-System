...
$backUrl = BASE_PATH . 'student';

if ($type == 'employee') {
    $table = 'employees';
    $backUrl = BASE_PATH . 'employees';
} elseif ($type == 'inventory') {
    $table = 'inventory_items';
    $backUrl = BASE_PATH . 'inventory';
} elseif ($type == 'others') {
    $table = 'others';
    $backUrl = BASE_PATH . 'others';
}
...
<div class="tabs-container">
    ...
    $type = isset($_GET['type']) ? trim($_GET['type']) : 'student';
    ?>
    <a href="<?= BASE_PATH ?>archive_list?type=student" class="tab-link <?= $type == 'student' ? 'active' : '' ?>"><i class="fa-solid fa-graduation-cap"></i> STUDENTS</a>
    <a href="<?= BASE_PATH ?>archive_list?type=employee" class="tab-link <?= $type == 'employee' ? 'active' : '' ?>"><i class="fa-solid fa-user-tie"></i> EMPLOYEES</a>
    <a href="<?= BASE_PATH ?>archive_list?type=inventory" class="tab-link <?= $type == 'inventory' ? 'active' : '' ?>"><i class="fa-solid fa-boxes-stacked"></i> INVENTORY</a>
    <a href="<?= BASE_PATH ?>archive_list?type=others" class="tab-link <?= $type == 'others' ? 'active' : '' ?>"><i class="fa-solid fa-clipboard-user"></i> OTHERS</a>
</div>

<section class="controls"
    style="display: flex; align-items: center; justify-content: space-between; flex-wrap: nowrap; gap: 20px; margin-bottom: 20px;">
    <?php
    $backLink = BASE_PATH . 'student';
    $backLabel = 'Back to Student Records';

    if ($type == 'employee') {
        $backLink = BASE_PATH . 'employee';
        $backLabel = 'Back to Employee Records';
    } elseif ($type == 'inventory') {
        $backLink = BASE_PATH . 'inventory';
        $backLabel = 'Back to Inventory';
    } elseif ($type == 'others') {
        $backLink = BASE_PATH . 'others';
    ...
    <div style="display: flex; gap: 10px; align-items: center; flex: 1; justify-content: flex-end;">
        ...
        <div class="dropdown" style="margin-left: 0;">
            ...
            <div class="dropdown-content">
                <a href="<?= BASE_PATH ?>export_pdf?type=<?= $type ?>&archived=1"><i class="fa-solid fa-file-pdf"></i> DOWNLOAD
                    PDF</a>
                <a href="<?= BASE_PATH ?>export_xlsx?type=<?= $type ?>&archived=1"><i class="fa-solid fa-file-excel"></i> DOWNLOAD
                    XLSX</a>
            </div>
        </div>
    </div>
