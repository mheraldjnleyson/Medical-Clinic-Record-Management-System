...
<script>
    ...
    function activateUser(userId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `<?= BASE_PATH ?>user_actions?action=activate&id=${userId}`;
            }
        });
    }
    ...
    function deactivateUser(userId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `<?= BASE_PATH ?>user_actions?action=deactivate&id=${userId}`;
            }
        });
    }

    function editUser(userId) {
        window.location.href = `<?= BASE_PATH ?>edit_user?id=${userId}`;
    }
    ...
    function deleteUser(userId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `<?= BASE_PATH ?>user_actions?action=delete&id=${userId}`;
            }
        });
    }
