...
$fieldsToMerge = [
    ...
    'employee' => ['department', 'entry_date', 'birth_date', 'gender', 'civil_status', 'school_district_division', 'position', 'designation', 'first_year_in_service', 'salary_grade', 'address', 'birthplace', 'religion'],
