...
if (isset($conn)) {
    ...
    $invExpRes = $conn->query("SELECT id FROM inventory_items WHERE (category != 'Equipment' AND expiry_date IS NOT NULL AND expiry_date <= CURDATE()) OR (category = 'Equipment' AND LOWER(expiry_date) LIKE '%non%')");
    if ($invExpRes) {
