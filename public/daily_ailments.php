...
<div class="ailments-container">
    ...
    <div class="report-header"
        ...
        <div>
            <h1 style="color: #00ACB1; margin: 0; font-size: 1.5rem;">
                Daily Ailments Report -
                <?= ($dateFrom === $dateTo) ? date('F d, Y', strtotime($dateFrom)) : date('M d, Y', strtotime($dateFrom)) . ' - ' . date('M d, Y', strtotime($dateTo)) ?>
            </h1>
        ...
        <div class="report-nav" style="margin-bottom: 0; flex-wrap: wrap; gap: 8px;">
            <a href="census">Monthly Census</a>
            <a href="daily_ailments" class="active">Daily Ailments</a>
            <a href="pe_monitoring">Physical Exam</a>
        </div>
    </div>
                ...
                .then(data => {
                    ...
                    if (data.risk_level) {
                        ...
                        if (data.analysis_details && data.analysis_details.length > 0) {
                            ...
                            fallbackLabel.className = 'no-print';
