...
<body>
        ...
        <form id="publicAddEmployeeForm" class="form-body">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="department" name="department" list="department_list" placeholder="Select or type department" required autocomplete="off">
    ...
    <script>
        // --- DEVICE LOCK LOGIC ---
        /* 
            Device lock disabled as per user request to allow multiple/duplicate entries.
