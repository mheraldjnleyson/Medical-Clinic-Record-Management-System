...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        // 3. Validate Department (formerly Dates logic)
        ...
        $stmt->bind_param("sssssssssi", $department, $name, $birth_date, $gender, $civil_status, $school_district_division, $position, $designation, $first_year_in_service, $id);
